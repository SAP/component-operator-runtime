...
var _ = Describe("testing: util.go", func() {
	...
	Describe("testing: must()", func() {
		...
		It("should not panic if no error occurs", func() {
			Expect(func() { must(5, nil) }).NotTo(Panic())
		})

		It("should panic if an error occurs", func() {
			Expect(func() { must(5, errors.New("an error occurred")) }).To(Panic())
		})
	...
	Describe("testing: sha256hex()", func() {
		...
		It("should produce a valid SHA-256 hex string", func() {
			Expect(sha256hex([]byte("test"))).To(Equal("9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"))
		})
	...
	Describe("testing: sha256base32()", func() {
		...
		It("should produce a valid SHA-256 base32 string", func() {
			Expect(sha256base32([]byte("test"))).To(Equal("t6dnbamijr6wlgrp5kqmkwwqcwr36ty3fmfyelgrlvwblmhqbiea"))
		})
	...
	Describe("testing: calculateObjectDigest()", func() {
		...
		BeforeEach(func() {
			...
			componentDigest = sha256hex([]byte("12345"))
		})
