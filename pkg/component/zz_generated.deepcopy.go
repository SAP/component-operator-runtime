...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReapplySpec) DeepCopyInto(out *ReapplySpec) {
	*out = *in
	if in.ReapplyInterval != nil {
		in, out := &in.ReapplyInterval, &out.ReapplyInterval
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReapplySpec.
func (in *ReapplySpec) DeepCopy() *ReapplySpec {
	if in == nil {
		return nil
	}
	out := new(ReapplySpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SuspensionSpec.
...
func (in *TypeSpec) DeepCopyInto(out *TypeSpec) {
	*out = *in
	if in.AdditionalManagedTypes != nil {
		in, out := &in.AdditionalManagedTypes, &out.AdditionalManagedTypes
		*out = make([]reconciler.TypeInfo, len(*in))
		copy(*out, *in)
	}
}
